function [parttransforms, meshr, meshQ, vertex_axis, final_A_1] = scapetracking_withoutshape()
...
mesh = importdata(strcat('D:\matlab_code\scapecode\scape\2.obj'));
...
for tb = 1:trinum
    ...
    b_final_sub_1 = r_sub * meshQ_sub * b_final_sub_1';
    b_final_sub_2 = r_sub * meshQ_sub * b_final_sub_2';
